...
function getEmbed(data, showInfo) {
    ...
    return {
        ...
        footer: {
            ...
            text: `Discord-Vente | github.com/vxshugo`
        },
        fields: fields
    }
}
...
client.on('message', message => {
    ...
    if (message.content.toLowerCase().startsWith(config.prefix)) {
        ...
        if (command === 'status' || command === 'uptime') {
            ...
            let embed = {
                title: ':satellite: Discord-Vente Status',
                color: 0x7289DA,
                description: ``,
                footer: {
                    icon_url: 'https://i.4da.ms/cNexOb.png',
...
client.on('ready', () => {
    ...
    console.log('Discord-Vente online!');
